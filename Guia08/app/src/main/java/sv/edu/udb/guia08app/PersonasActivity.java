    ...
    private void inicializar() {
        ...
        listaPersonas.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(getBaseContext(),  sv.edu.udb.guia08app.AddPersonaActivity.class);
                ...
                intent.putExtra("nacimiento",personas.get(i).getNacimiento());
        ...
        listaPersonas.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, final int position, long l) {
                    ...
                    AlertDialog.Builder ad = new AlertDialog.Builder( sv.edu.udb.guia08app.PersonasActivity.this);
                    ad.setMessage("Está seguro de eliminar registro?")
                            .setTitle("Confirmación");

                    ad.setPositiveButton("Si", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            sv.edu.udb.guia08app.PersonasActivity.refPersonas
                                    .child(personas.get(position).getKey()).removeValue();

                            Toast.makeText(  sv.edu.udb.guia08app.PersonasActivity.this,
        ...
        fab_agregar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(getBaseContext(),  sv.edu.udb.guia08app.AddPersonaActivity.class);
                i.putExtra("accion","a"); // Agregar
                i.putExtra("key","");
                i.putExtra("nombre","");
                i.putExtra("dui","");
                i.putExtra("nacimiento","");
                i.putExtra("genero","");
                i.putExtra("peso","");
                i.putExtra("altura","");
                startActivity(i);
        ...
        consultaOrdenada.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                AdaptadorPersona adapter = new AdaptadorPersona( sv.edu.udb.guia08app.PersonasActivity.this,
                       personas );
